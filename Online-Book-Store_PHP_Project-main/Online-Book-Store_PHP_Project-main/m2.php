...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["payment_submit"])) {
    ...
    // and handle the response from the payment gateway accordingly.
    
    // Example response handling
    $paymentSuccessful = true; // Set this based on the actual response from the payment gateway
    if ($paymentSuccessful) {
        // Payment successful, perform further actions (e.g., save transaction details in the database, send confirmation email, etc.)
        // ...
